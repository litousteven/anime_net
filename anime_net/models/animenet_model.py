...
from anime_net.data.degradation import Degradation
from anime_net.data.degradation_simple import DegradationSimple
from anime_net.models.srgan_model import SRGANModel
...
class AnimeNetModel(SRGANModel):
    ...
    def feed_data(self, data):
        if self.is_train and self.opt.get('high_order_degradation', True):
            ...
            self.gt, self.lq = self.degradation.degrade_data(data)
